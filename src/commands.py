...
ytdl_format_options = {
    ...
    'no_warnings': True,
    'default_search': 'auto',
    'source_address': '0.0.0.0' # ผูกกับ ipv4 เนื่องจากที่อยู่ ipv6 ทำให้เกิดปัญหาในบางครั้ง
}

ffmpeg_options = {
    'options': '-vn',
    "before_options": "-reconnect 1 -reconnect_streamed 1 -reconnect_delay_max 5" ## เพลงจะจบถ้าไม่มีบรรทัดนี้
}
...
class commandsAPI:
    ...
    async def queue(self,ctx):
        ...
        embed = discord.Embed(title=f'NEXT SONG {len(upcoming)}', description=fmt)
    ...
    async def help(self,ctx):
        ...
        emBed.add_field(name=".play", value="คำสั่งเล่นเพลง", inline=False)
        ...
        emBed.set_thumbnail(url='https://i.imgur.com/vNcQl10.jpg')
